...
using bankApp_lists_.BL;
using System.IO;

namespace bankApp_lists_
{
    class Program
    {
        //
        ...
        static void Main(string[] args)
        {
            ...
            bankClass2 bankInfo = new bankClass2();
        ...
        public static int login(List<bankClass> users,bankClass2 bankInfo)
        {
        ...
        public static void signUp(List<bankClass> users,bankClass2 bankInfo)
        {
        ...
        //
        //
        public static bool adminBankCode(List<bankClass> users,bankClass2 bankInfo)
        {
            string bankCode1 = "";
        ...
        public static void adminMenu(List<bankClass> users,bankClass2 bankInfo)
        {
            bool logout = false;
            while (true)
            {
        ...
        public static bool adminMenuOptions(string choice, List<bankClass> users,bankClass2 bankInfo)
        {
            bool logout = false;
            if (choice == "1")
            {
        ...
        public static void adminBalance(List<bankClass> users,bankClass2 bankInfo)
        {
            Console.Clear();
            header();
        ...
        public static void editAdmin(List<bankClass> users,bankClass2 bankInfo)
        {
            Console.Clear();
            header();
        ...
        public static void delAccount(bool checkAdmin, List<bankClass> users,bankClass2 bankInfo)
        {
        ...
        public static void delAdmin(int index, List<bankClass> users,bankClass2 bankInfo)
        {
            string bankCode1;
            int choice;
        ...
        */
        ...
        public static bool confirmRole(List<bankClass> users, bankClass2 bankInfo)
        {
        ...
        public static void loadData(List<bankClass> users,bankClass2 bankInfo )
        {
